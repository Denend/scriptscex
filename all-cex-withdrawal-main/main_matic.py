...
network = "Polygon"     # ID сети
proxy_server = "http://login:password@IP:port"

#----second-options----#
amount = [1.6, 2.1]          # минимальная и максимальная сумма
decimal_places = 3           # количество знаков, после запятой для генерации случайных чисел
delay = [21, 251]             # минимальная и максимальная задержка
...
if __name__ == "__main__":
    with open("wallets_matic.txt", "r") as f:
