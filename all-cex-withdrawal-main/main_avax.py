...
symbolWithdraw = "AVAX"      # символ токена
network = "Avalanche C-Chain"     # ID сети
proxy_server = "http://login:password@IP:port"

#----second-options----#
amount = [0.14, 0.21]          # минимальная и максимальная сумма
decimal_places = 2           # количество знаков, после запятой для генерации случайных чисел
delay = [11, 310]             # минимальная и максимальная задержка
shuffle_wallets = "yes"       # нужно ли мешать кошельки yes/no
#----end-all-options----#
...
class API:
    ...
    # okx API
    okx_apikey = "d2eb6196-eb1d-4a7a-ac57-d1404ab2e8d0"
    okx_apisecret = "CCB0F63823BAD4B599E832E2D352FCB6"
    okx_passphrase = "Cpxzimba123@"
    # bybit API
...
if __name__ == "__main__":
    with open("wallets_avax.txt", "r") as f:
