...
#----second-options----#
amount = [11, 21]          # минимальная и максимальная сумма
decimal_places = 1           # количество знаков, после запятой для генерации случайных чисел
delay = [15, 330]             # минимальная и максимальная задержка
...
if __name__ == "__main__":
    with open("wallets_usdc.txt", "r") as f:
